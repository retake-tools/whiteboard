...
assert.match(executionInspectorSource, /detailImageAsset/);
assert.match(executionInspectorSource, /<ImageAssetDetails/);
assert.match(executionInspectorSource, /inspector\.imageDetails/);
