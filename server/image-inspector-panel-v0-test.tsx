...
assert.match(appSource, /<ImageInspectorPanel[\s\S]*onBeforePluginOperationAction=\{async \(\) => \{[\s\S]*setInspectorBlockId\(undefined\);[\s\S]*await nextAnimationFrame\(\);[\s\S]*await nextAnimationFrame\(\)/);
