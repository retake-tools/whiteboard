...
async function writeReactPluginSource(sourceRoot: string): Promise<void> {
  ...
  await writeFile(
    ...
    [
      ...
      '});',
      '',
      'export const fixtureAction = definePluginContribution({',
      '  apiVersion: 1,',
      '  kind: "action",',
      '  label: "Plugin download image",',
      ...
      '    fixture.actionInvocationCount = (fixture.actionInvocationCount ?? 0) + 1;',
      '    fixture.lastActionAssetId = asset.assetId;',
      '  },',
      '});',
      '',
